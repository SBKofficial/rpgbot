...
tier_a_list = [
    "INDUSTOWER.NS", "KALYANKJIL.NS", "VEDL.NS", "TATASTEEL.NS", 
    "UBL.NS", "NAUKRI.NS", "LT.NS", "MOTHERSON.NS", 
    "ADANIPORTS.NS", "HINDPETRO.NS", "POWERGRID.NS", "TVSMOTOR.NS", 
    "SIEMENS.NS", "BAJAJ-AUTO.NS", "NTPC.NS"
]
